...
export class UserRoleMapper extends Mapper<UserRoleAggregate, UserModel> {
  constructor (
  ...
  public toDomain (userModel: UserModel): UserRoleAggregate {
  ...
  public toPersistence (_userEntity: UserRoleAggregate): UserModel {
