<template>
  <account-layout>
    <div>
      <app-page-hero
        title="Perfil"
        sub-title="Informações do utilizador"
      />
        ...
        <div class="padding sr">
          <div class="card">
            <div
              ...
              style="background-image: url(/vendor/img/b3.jpg)"
              data-plugin="stellar"
            >
                ...
                <div class="d-md-flex">
                  <div class="p-4">
                    <div class="d-flex">
                      ...
                      <div class="mx-3">
                        <h5 class="mt-2">{{ $page.props.user.fullName }}</h5>
                        <div class="text-fade text-sm">
                          <span class="m-r">Senior Industrial Designer</span>
                          <small> <i class="fa fa-map-marker mr-2"></i>London, UK</small>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="p-3">
              <div class="d-flex">
                <ul class="nav nav-pills">
                  <li class="nav-item">
                    <a class="nav-link active" href="#" data-toggle="tab" data-target="#tab_4">Dados do perfil</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="tab" data-target="#tab_2">Actividades</a>
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <div class="card">
                    ...
                    <div class="px-4 py-4">
                      ...
                      <div>
                        ...
                        <div class="my-2">
                          Ut maecenas sed purus ultrices sed sapien massa quam eu sed odio id dui,
                          sed sed lectus amet cursus sed habitant est morbi adipiscing nam
                          consectetur nullam urna, proin condimentum ut laoreet congue felis, diam
                          pulvinar aliquam libero non tortor turpis aliquet massa eu etiam eget
                          quisque egestas tristique tempus purus blandit nunc volutpat aliquam amet,
                          aliquet nec et sed
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card p-4">
                    <div class="timeline animates animates-fadeInUp">
                      ...
                      <div class="tl-item">
                        ...
                        <div class="tl-content">
                          <div class="">
                            Just saw this on the <a href="#">@eBay</a> dashboard, dude is an
                            absolute unit.
                          </div>
                      ...
                      <div class="tl-item">
                        <div class="tl-dot"></div>
                        <div class="tl-content">
                          <div class=""><a href="#">@NextUI</a> submit a ticket request</div>
                      ...
                      <div class="tl-item">
                        ...
                        <div class="tl-content">
                          <div class="">
                            Developers of <a href="#">@iAI</a>, the AI assistant based on Free
                            Software
                          </div>
                      ...
                      <div class="tl-item">
                        ...
                        <div class="tl-content">
                          <div class="">
                            From design to dashboard, <a href="#">@Dash</a> builds custom hardware
                      ...
                      <div class="tl-item">
                        ...
                        <div class="tl-content">
                          <div class="">
                            Fun project from this weekend. Both computer replicas are fully
                            functional
                          </div>
